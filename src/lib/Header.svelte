...
<svelte:head>
	<meta name="description" content="Knitting Pro courses will have you getting warm in no time!" />
...
<header class="container" class:isHome>
	<div class="nav-top flex" class:isCourse>
		<div class="logo">
			<a href="/">
				{#if mediaSml}
					<img src="/img/logo-small.svg" alt="KnittingPro Logo" width="45px" height="21px" />
				{:else}
					<img src="/img/logo-large.svg" alt="KnittingPro Logo" width="114px" height="21px" />
				{/if}
			</a>
		</div>
